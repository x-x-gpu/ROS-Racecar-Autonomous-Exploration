    ...
    for (unsigned int nbr : nhood8(idx, *costmap_)) {
      ...
      if (isNewFrontierCell(nbr, frontier_flag)) {
        ...
        if (distance < output.min_distance) {
          ...
          // update centroid of frontier
          // for (unsigned int nbrbr : nhood4(nbr, *costmap_)) {
          //   if (map_[nbrbr] == FREE_SPACE) {
          //     unsigned int fmx, fmy;
          //     double fwx, fwy;
          //     costmap_->indexToCells(nbrbr, fmx, fmy);
          //     costmap_->mapToWorld(fmx, fmy, fwx, fwy);
          //     output.centroid.x = fwx;
          //     output.centroid.y = fwy;
          //   }
          // }
        }
