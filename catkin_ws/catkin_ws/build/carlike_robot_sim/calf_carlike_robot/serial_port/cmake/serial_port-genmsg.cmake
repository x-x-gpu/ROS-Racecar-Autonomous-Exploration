...
set(MSG_I_FLAGS "-Iserial_port:/home/admin/catkin_ws/src/carlike_robot_sim/calf_carlike_robot/serial_port/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Iserial_port:/home/admin/catkin_ws/src/carlike_robot_sim/calf_carlike_robot/serial_port/msg")
...
get_filename_component(_filename "/home/admin/catkin_ws/src/carlike_robot_sim/calf_carlike_robot/serial_port/msg/header.msg" NAME_WE)
add_custom_target(_serial_port_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "serial_port" "/home/admin/catkin_ws/src/carlike_robot_sim/calf_carlike_robot/serial_port/msg/header.msg" ""
)
...
_generate_msg_cpp(serial_port
  "/home/admin/catkin_ws/src/carlike_robot_sim/calf_carlike_robot/serial_port/msg/header.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(TARGET serial_port_generate_messages_cpp)
  add_dependencies(serial_port_generate_messages_cpp serial_port_generate_messages_cpp)
endif()
...
if(TARGET serial_port_generate_messages_eus)
  add_dependencies(serial_port_generate_messages_eus serial_port_generate_messages_eus)
endif()
...
if(TARGET serial_port_generate_messages_lisp)
  add_dependencies(serial_port_generate_messages_lisp serial_port_generate_messages_lisp)
endif()
...
if(TARGET serial_port_generate_messages_nodejs)
  add_dependencies(serial_port_generate_messages_nodejs serial_port_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_port)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/serial_port\")")
  # install generated code
  install(
...
if(TARGET serial_port_generate_messages_py)
  add_dependencies(serial_port_generate_messages_py serial_port_generate_messages_py)
endif()
